      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="mb-8">
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Cadastre uma manutenção e acompanhe sua execução.
          </p>
        </div>
        ...
        >
          ...
          <section className="border-t border-zinc-100 p-6 sm:p-7">
            <div className="mb-6">
              ...
              <p className="mt-1 text-xs text-zinc-500">
                Cadastre quem ficará responsável pelo serviço.
              </p>
            </div>
          ...
          <section className="border-t border-zinc-100 p-6 sm:p-7">
            <div className="mb-6">
              ...
              <p className="mt-1 text-xs text-zinc-500">
                Defina o estado atual da manutenção e adicione observações.
              </p>
            </div>
